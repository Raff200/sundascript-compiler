...
- Pengecekan variabel yang belum dideklarasikan
- Validasi `eureun` (break) dan `terus_weh` (continue) hanya di dalam loop
- Manajemen scope untuk fungsi, kelas, dan blok kontrol
...
2. Mesin analitik mampu menemukan dan melaporkan lokasi variabel yang tidak valid dengan akurasi **100%**.
