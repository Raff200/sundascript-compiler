...
2. Hasil uji coba terbukti mampu mengkonversi blok kondisional `lamun_deui` yang semula berisi **30+ token mentah** menjadi representasi kelas biner tunggal, mereduksi hingga lebih dari **60% noise tata bahasa**.
